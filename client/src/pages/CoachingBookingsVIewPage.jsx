...
//                                 return<tr key={index} className="text-gray-800">
...
//                                         <Link to={`/updateUser/${user._id}`} className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Reshedule</Link>
//                                         <button onClick={(e) => handleDelete(user._id)} className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded ml-2">Cancel</button>
//                                     </td>
//                                 </tr>
//                             })}
//                         </tbody>
                                ...
                                return (
                                    <tr key={index} className={index % 2 === 0 ? "bg-gray-600" : "bg-gray-700"}>
                                        ...
                                        <td className="border px-6 py-2 flex justify-center items-center">
                                            <Link to={`/updateUser/${user._id}`} className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Reschedule</Link>
                                            <button onClick={(e) => handleDelete(user._id)} className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded ml-2">Cancel</button>
                                        </td>
                                    </tr>
                                );
