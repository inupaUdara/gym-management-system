      ...
      <div className="mx-auto" style={{ height: '700px' }}>
        <div className="flex justify-center h-full px-6 py-12">
          <div className="flex w-full h-full xl:w-3/4 lg:w-11/12">
            <div className="hidden bg-gray-400 rounded-l-lg dark:bg-gray-800 lg:block lg:w-5/12" style={{ backgroundImage: `url(${user && user.profilePicture})`, backgroundSize: 'cover', width: '300px', height: '300px' }}>
            </div>
