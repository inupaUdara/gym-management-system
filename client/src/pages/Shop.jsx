...
import supplementcover1 from '../assets/supplementcover.jpeg';
  ...
  return (
    <>
      ...
      <div className="relative">
        <img src={supplementcover1} alt="Cover 1" className="w-full h-64 object-cover" />
   
       
        </div>
      <div className="mt-12 mx-auto max-w-7xl px-4">
  <h1 className="text-4xl font-extrabold italic mb-8 text-center text-gray-800 dark:text-gray-200">Explore Our Supplements</h1>
