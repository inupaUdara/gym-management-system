...
export default function CoachingFormPage() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post("http://localhost:3001/createUser", { name, email, age, cname, date, time, msg })
            .then(result => {
                console.log(result);
    ...
    return (
        ...
        <div className="flex justify-center items-center min-h-screen bg-cover bg-center" style={{ backgroundImage: `url(${gymImg})` }}>
            ...
            <div className="bg-black bg-opacity-80 max-w-md mx-auto p-6 rounded-lg shadow-md">
                <h2 className="text-2xl font-semibold mb-6 text-center text-white">Book an Appointment</h2>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex mb-4">
                        <div className="w-1/2 mr-2">
                            <label htmlFor="contactNumber" className="block text-white">Contact Number</label>
                            <input
                                type="tel"
                                id="contactNumber"
                                name="contactNumber"
                        ...
                        <div className="w-1/2 ml-2">
                            <label htmlFor="coachName" className="block text-white">Coach Name</label>
                            <select
                                id="coachName"
                                name="coachName"
                                value={cname}
                    ...
                    <div className="flex mb-4">
                        ...
                        <div className="w-1/2 ml-2">
                            <label htmlFor="timeSlot" className="block text-white">Time Slot</label>
                            <select
                                id="timeSlot"
                                name="timeSlot"
                                value={time}
                    ...
                    <div className="mb-4">
                        <label htmlFor="specialMessage" className="block text-white">Special Messages</label>
                        <textarea
                            id="specialMessage"
                            name="specialMessage"
                            value={msg}
