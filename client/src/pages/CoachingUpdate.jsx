        ...
        <div>  
            ...
            <div className="flex justify-center items-center min-h-screen bg-cover bg-center" style={{ backgroundImage: `url(${gymImg})` }} >
                <div className="bg-black bg-opacity-80 max-w-lg mx-auto p-6 rounded-lg shadow-md">
                    <h2 className="text-2xl font-semibold mb-6 text-center text-white">Update Appointment</h2>
                    <form onSubmit={updateAppointment}>
                        <div className="mb-4">
                        ...
                        <div className="mb-4">
                            <label className="block text-white" htmlFor="contactNumber">Contact Number</label>
                            <input
                                type="tel"
                                id="contactNumber"
                                name="contactNumber"
                        ...
                        <div className="mb-4">
                            <label className="block text-white" htmlFor="coachName">Coach Name</label>
                            <select
                                id="coachName"
                                name="coachName"
                                value={cname}
                        ...
                        <div className="mb-4">
                            <label className="block text-white" htmlFor="date">Date</label>
                            <input
                                type="date"
                                id="date"
                                name="date"
                        ...
                        <div className="mb-4">
                            <label className="block text-white" htmlFor="timeSlot">Time Slot</label>
                            <select
                                id="timeSlot"
                                name="timeSlot"
                                value={time}
                        ...
                        <div className="mb-4">
                            <label className="block text-white" htmlFor="specialMessage">Special Messages</label>
                            <textarea
                                id="specialMessage"
                                name="specialMessage"
                                value={msg}
