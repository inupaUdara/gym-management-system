...
const ManagerShowProtein = () => {
  ...
  const [totalSupplements, setTotalSupplements] = useState(0); // State for total users
...
const generatesuplementReport = () => {
  ...
  return (
    ...
    {/* <p className="mb-4 text-center text-gray-700 text-m dark:text-gray-800 ">
        Total Proteen: {totalSupplements}
      </p> */}
...
export default ManagerShowProtein;
